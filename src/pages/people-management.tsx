  ...
  const fetchProjects = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `${baseURL}/projects?page=${currentPage}&sectorId=3`,
        {
          method: 'GET',
          headers: {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-20 gap-8">
      <div className="w-full flex items-center justify-between">
        <div className="flex gap-4">
          <h1 className="text-3xl font-semibold">Gestão de pessoas</h1>
                ...
                <div className="grid w-full items-center gap-2">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        {newProject.deadline ? (
                          new Date(newProject.deadline).toLocaleDateString(
                            'pt-BR'
                          )
                        ) : (
        ...
        <Button
          ...
          onClick={() => {
            navigate('/dashboard/documentos/3')
          }}
        >
          Documentos
        </Button>
              ...
              <div className="grid w-full items-center gap-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      {new Date(projectToUpdate.deadline).toLocaleDateString(
                        'pt-BR'
                      )}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      mode="single"
                      selected={new Date(projectToUpdate.deadline)}
                      onSelect={date => {
                        if (date) {
                          const timezoneOffset =
                            date.getTimezoneOffset() * 60000
